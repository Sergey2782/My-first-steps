...
// ------- same manipulations using  " setInterval "
var mInterval;
$(".btn_do_large_second").click(function(){
			var mInterval = setInterval(resizeImageBySetInt, 200);
		}) 
	

var normalMaxWidth = 640;

function resizeImageBySetInt(){

var i = document.images[1]; //you can use image name


	if(i.width < normalMaxWidth){

		i.width *= 1.1;
		i.height *=1.1;
	}

	else if (i.width >= normalMaxWidth)
...
var xInterval;
$(".btn_do_small_second").click(function(){
		var xInterval = setInterval(reduceImageBySetInt, 200);
		}) 

var normalMinWidth = 200;

function reduceImageBySetInt(){

var i = document.images[1];//you can use image name


	if(i.width > normalMinWidth){

		i.width *= 0.9;
		i.height *=0.9;
	}
	else if (i.width <= normalMinWidth)
